...
const Todolist = () => {
    ...
    try {
        ...
        let result = await fetch("https://playground.4geeks.com/todo/users/Chipitico");
    ...
    return (
        <div className="container mt-5" style={{ maxWidth: "600px" }}>
            <h1 className="fw-bold text-dark mb-1 text-center">Chipitico's Todolist</h1>
            <p className="text-secondary mb-4 text-center">Gestiona tus que haceres aquí abajo.</p>
                ...
                {tasks.map((task) => (
                    ...
                    >
                        <div className="d-flex align-items-center gap-2">
                            ...
                            />
                            <span
                                className={task.done ? "text-decoration-line-through text-secondary" : "text-dark"}
                            >
                                {task.text}
                            </span>
                        </div>
